...
void Robot::RobotInit() {
	...
	doubleAutonomousCommand = new DoubleAutonomousCommandGroup();
	
	autoChooser = new SendableChooser();
	autoChooser->AddDefault("Single Auto", autonomousCommand);
	autoChooser->AddObject("Double Auto", doubleAutonomousCommand);
