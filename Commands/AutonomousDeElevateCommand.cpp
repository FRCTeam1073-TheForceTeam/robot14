...
#define AUTO_DELEVATE_PREF "autoDelevateTimeout"
AutonomousDeElevateCommand::AutonomousDeElevateCommand() {
	...
	const float autoDelevateTimeoutDefault = 0.3f;
	double autoTimeout = Robot::prefs->GetFloat(AUTO_DELEVATE_PREF, autoDelevateTimeoutDefault);
	SetTimeout(autoTimeout);
}
