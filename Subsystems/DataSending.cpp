...
void DataSending::SendTheData(){
	...
	Send((packetCount));//number of packets
...
void DataSending::GetDriveJoystickInfo(){
	...
	Send(Robot::oi->getForwardDirectionButton()->Get());
	Send(Robot::oi->getToggleDriveMode()->Get());
	Send(Robot::oi->getHighGear()->Get());
	Send(Robot::oi->getLowGear()->Get());
}
void DataSending::GetOperatorJoystickInfo(){
	Send(Robot::oi->getCatchModeButton()->Get());
	Send(Robot::oi->getCollectorToShooterButton()->Get());
	Send(Robot::oi->getCollectorDownButton2()->Get());
	Send(Robot::oi->getCollectorDownButton()->Get());
	Send(Robot::oi->getCollectorUpButton2()->Get());
	Send(Robot::oi->getCollectorUpButton()->Get());
	Send(Robot::oi->getCollectButtonToggle()->Get());
	Send(Robot::oi->getCollectButtonHold()->Get());
	Send(Robot::oi->getPurgeButton()->Get());
	Send(Robot::oi->getLaunchBallButton()->Get());
}
